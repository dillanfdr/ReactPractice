				...
				<div className="flex gap-[30px] px-24">
					<div className="">
						<img
							...
							className="rounded-lg shadow-lg block w-[500px] h-[500px] mr-[150px] object-cover"
						/>
					</div>
					<div className="flex flex-col gap-[20px]">
						...
						<p className="max-w-[500px] whitespace-pre-line">{product.description ?? "No description."}</p>
					</div>
				</div>
			</div>
		</>
